...
def  drama(fileSys,fileRef, /, *,binSize = 1,saveDir = '',saveName='',borderline = None,vMax=None,saveAsTif = True, plotData = True, animatedGif=False, mixt=False,tfs=18):
...
#------------------------------------Saving results ----------------------------------------------------                   
    ...
    if plotData:
        ...
        plt.xlabel("$\\phi$", fontsize = lfs)
        plt.ylabel("$\\psi$", fontsize = lfs)
        
        cbar = plt.colorbar()#orientation='horizontal',location = "bottom")
        ...
        cmapr = matplotlib.colors.LinearSegmentedColormap.from_list("gray", ["white",(0.3, 0.0, 0.0),(1, 0.5, 0),(1, 1, 0)],N=256)          #Defining color map
        cmapb = matplotlib.colors.LinearSegmentedColormap.from_list("gray", ["white",(0.0, 0.0, 0.3),(0.0, 0.5, 1),(0, 1, 1)],N=256)        
