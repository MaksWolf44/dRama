...
def  drama(fileSys,fileRef, /, *,binSize = 1,saveDir = '',saveName='',borderline = None,vMax=None,saveAsTif = True, plotData = True, animatedGif=False, mixt=False,tfs=18,plotRaw=False,pureText=False):
...
os.chdir(katalog)
drama("system.xvg","reference.xvg",plotRaw=True,animatedGif=True,pureText=True)
